...
for(let i = 0; i < fraMartino.length; i++)fraMartino[i] = (fraMartino[i] + 12) * 16;
function starting() {
    series = 0;
    ...
    function GenerationHoleSeries(ObB, ObT) {
        ...
        series++;
        if (series == fraMartino.length) series = 0;
        //console.log(series);
    ...
    setInterval(function() {
        ...
        if (ObstacleTLeft < 100 && ObstacleTLeft > 50 || ObstacleT2Left < 100 && ObstacleT2Left > 50) insideObstacle = true;
        else if (insideObstacle == true) {
            score += 1;
